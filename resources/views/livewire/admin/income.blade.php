    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            <h3 class="fw-bold text-dark mb-2">
                <i class="bi bi-graph-up-arrow text-jg-blue me-2"></i> Day Summary Report
            </h3>
            ...
            <div class="card gradient-card" style="background: linear-gradient(135deg, #1a1a1a 0%, #000000 100%);">
                <div class="card-body text-white">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <h6 class="text-white-50 mb-0" style="font-size: 0.85rem; font-weight: 500; letter-spacing: 1px; color: #ffffff !important;">💰 OPENING CASH</h6>
                    </div>
                    <h2 class="fw-bold mb-0" style="color: #ffffff;">Rs. {{ number_format($openingCash, 2) }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class=" col-xl-3 col-md-6 mb-2">
                        <div class="card gradient-card" style="background: linear-gradient(135deg, #161b97 0%, #12167d 100%);">
                            <div class="card-body text-white">
                                ...
                                <h2 class="fw-bold mb-0" style="color: #ffffff;">Rs. {{ number_format($cashIncome, 2) }}</h2>
                </div>
            </div>
        </div>
            ...
            <div class="card gradient-card" style="background: linear-gradient(135deg, #f30b1f 0%, #d00000 100%);">
                <div class="card-body text-white">
                    ...
                    <h2 class="fw-bold mb-0">Rs. {{ number_format($todayReturns, 2) }}</h2>
                                                            ...
                                                            <div class="col-xl-3 col-md-6 mb-2">
                                                                <div class="card gradient-card" style="background: linear-gradient(135deg, #212121 0%, #424242 100%);">
                                                                    <div class="card-body text-white">
                                                                        ...
                                                                        <h2 class="fw-bold mb-0" style="color: #ffffff;">Rs. {{ number_format(($openingCash + $cashIncome + $cashLatePayments) - ($todayReturns + $todayDeposits+$todayExpenses + $supplierPayment), 2) }}</h2>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header" style="background: linear-gradient(135deg, #000000 0%, #1a1a1a 100%); border-bottom: 2px solid #161b97;">
                                                            <h5 class="fw-bold text-jg-blue mb-0">
                                                        ...
                                                        <div class="card-body p-0 overflow-auto">
                                                            <div class="table-responsive">
                                                                <table class="table table-hover mb-0">
                                                                    <thead style="background: #f8f9fa; border-bottom: 2px solid #161b97;">
                                                                        <tr class="text-dark">
